...
class UpscalePage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        queue_head.addWidget(self.queue_title); queue_head.addStretch()
        ...
        queue_head.addWidget(self.add_button); queue_head.addWidget(self.clear_button); rl.addLayout(queue_head)
